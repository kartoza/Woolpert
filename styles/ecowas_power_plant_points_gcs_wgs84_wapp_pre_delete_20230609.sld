        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <!--Parametric SVG-->
              <se:ExternalGraphic>
               <OnlineResource xlink:type="simple" xlink:href="file:///geoserver/data_dir/styles/svg/powerplants_hydrid.svg"/>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <!--Parametric SVG-->
              <se:ExternalGraphic>
               <OnlineResource xlink:type="simple" xlink:href="file:///geoserver/data_dir/styles/svg/powerplants_hydro.svg"/>
                <se:Format>image/svg+xml</se:Format>
              </se:ExternalGraphic>
              <!--Plain SVG fallback, no parameters-->
              <se:ExternalGraphic>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <!--Parametric SVG-->
              <se:ExternalGraphic>
               <OnlineResource xlink:type="simple" xlink:href="file:///geoserver/data_dir/styles/svg/powerplants_solar.svg"/>
                <se:Format>image/svg+xml</se:Format>
              </se:ExternalGraphic>
              <!--Plain SVG fallback, no parameters-->
              <se:ExternalGraphic>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <!--Parametric SVG-->
              <se:ExternalGraphic>
               <OnlineResource xlink:type="simple" xlink:href="file:///geoserver/data_dir/styles/svg/powerplants_wind.svg"/>
                <se:Format>image/svg+xml</se:Format>
              </se:ExternalGraphic>
              <!--Plain SVG fallback, no parameters-->
              <se:ExternalGraphic>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <!--Parametric SVG-->
              <se:ExternalGraphic>
               <OnlineResource xlink:type="simple" xlink:href="file:///geoserver/data_dir/styles/svg/powerplants_thermal.svg"/>
                <se:Format>image/svg+xml</se:Format>
              </se:ExternalGraphic>
              <!--Plain SVG fallback, no parameters-->
              <se:ExternalGraphic>
