...
class Model(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        master_layer_source_type = self.get_data_source_type(master_layer_pg)

        if master_layer_source_type is True:
    ...
    def geopackage_path(self, layer):
        path = layer.source().split("|")[0]
        return path

    def init_sql(self, master_layer, upload_layer, feedback):
