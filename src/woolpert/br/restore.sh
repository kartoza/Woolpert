...
# ##########################################################
# Run a restore
#  SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./woolpert/br/restore.sh $BKP_FOLDER_NAME
#   - BKP_FOLDER_NAME:
...
#
# e.g.:
#  docker exec -it django4woolpert sh -c 'SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./woolpert/br/restore.sh $BKP_FOLDER_NAME'
# ##########################################################
...
echo "-----------------------------------------------------"
echo "STARTING woolpert RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./woolpert/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED woolpert RESTORE $(date)"
echo "-----------------------------------------------------"
