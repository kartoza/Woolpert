...
# ##########################################################
# Run a backup
#  SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./woolpert/br/backup.sh $BKP_FOLDER_NAME
#   - BKP_FOLDER_NAME:
...
#
# e.g.:
#  docker exec -it django4woolpert sh -c 'SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./woolpert/br/backup.sh $BKP_FOLDER_NAME'
# ##########################################################
...
echo "-----------------------------------------------------"
echo "STARTING woolpert BACKUP $(date)"
echo "-----------------------------------------------------"
...
./manage.sh backup -i -f -c $PWD/woolpert/br/settings_docker.ini --backup-dir /$BKP_FOLDER_NAME/
