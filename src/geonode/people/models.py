...
class Profile(AbstractUser):
    ...
    organization_type = models.CharField(null=True, blank=True, max_length=255)
    reason_joining= models.TextField(_("Reason For Joining"), null=True, blank=True, help_text=_("Why do you want to register?"))
